...
public class ProdutoController {
	...
	@GetMapping("/lista_preco/{pc1}/{pc2}/{pc3}")
	public ResponseEntity<List<Produto>> getByListaPreco(@PathVariable BigDecimal pc1, @PathVariable BigDecimal pc2, @PathVariable BigDecimal pc3){
		List<BigDecimal> listaPreco = List.of(pc1, pc2, pc3);
